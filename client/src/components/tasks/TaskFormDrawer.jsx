...
const EMPTY_VALUES = { title: '', description: '', status: 'Pending', priority: 'Medium' };

export function TaskFormDrawer({ open, onClose, mode, initial, onSubmit, isSubmitting, error }) {
  ...
  return (
    <Drawer
      ...
      description={mode === 'create' ? 'Add a task to your list.' : 'Update the details of this task.'}
      footer={
    ...
    >
      ...
      <div className="py-4">
        ...
        <Textarea placeholder="Optional details" value={values.description} onChange={(e) => set('description', e.target.value)} />
      </div>
